...
from aloha_ros2_receiver.constants import MASTER2PUPPET_JOINT_FN
...
class FollowerArm(InterbotixManipulatorXS):
    def __init__(self):
        ...
        # subscribe to the leader's joint states
        ...
        self.node.get_logger().info("FollowerArm initialized")
